...
$arama=@mysql_real_escape_string($_POST['dosya_ara']);

$result=@mysql_query("select * from dosyalar where name like '%$arama%'");
...
echo  "<script type='text/javascript'>alert('$mesaj');window.location='http://localhost/search.php';</script>";
